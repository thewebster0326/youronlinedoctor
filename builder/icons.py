...
_FILLED = {
    ...
    "tiktok":
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M16.6 5.8a4.8 4.8 0 0 1-1.2-3.2h-3.2v12.9a2.6 2.6 0 1 1-1.9-2.5V9.7a5.8 5.8 0 1 0 5.1 5.7V9.1a7.9 7.9 0 0 0 4.4 1.4V7.3a4.7 4.7 0 0 1-3.2-1.5z"/></svg>',
    "menu":
